...
function selectAll() {
    ...
    for (var i = 0; i < items.length; i++) {
        if (items[i].type == 'checkbox' && items[i].checked == true){
            ...
            document.getElementById('checker').innerHTML = '<i class="icon-plus mr-3"></i>Select All';
        }
        else{
            items[i].checked = true;
            document.getElementById('checker').innerHTML = '<i class="icon-minus mr-3"></i>Unselect All';
        }
    }
}
