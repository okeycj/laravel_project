                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input readonly class="form-control" value="<?php
                                        //  if($user->data()->status == 1) {echo 'Active';} else {echo 'Inactive';} 
                                         ?>" type="text">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="onboarding-content p-5 mt-5">
                            ...
                            <form method="post" action="update.php">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lname">Last Name</label><input name="lname" value="<?php
                                            //  echo $user->data()->lastname;
                                              ?>" class="form-control" data-error="Please input your Last Name" placeholder="eg: Doe" required="required" type="text">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="fname">First Name</label><input name="fname" value="<?php
                                            //  echo $user->data()->firstname;
                                              ?>" class="form-control" data-error="Please input your First Name" placeholder="eg: John" required="required" type="text">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email">Email address</label><input name="email" value="<?php 
                                            // echo $user->data()->email;
                                            ?>" class="form-control" data-error="Your email address is invalid" placeholder="Enter email" autocomplete="email" required="required" type="email">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                <option <?php
                                                //  if($user->data()->status == 1) {echo "selected";} 
                                                ?> value="1">Active</option>
                                                <option <?php
                                                //  if($user->data()->status == 0) {echo "selected";} 
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="state">State</label><input name="state" value="<?php 
                                            // echo $user->data()->state;
                                            ?> State" class="form-control" data-error="Please input your State" placeholder="eg: Enugu State" required="required" autocomplete="state" type="text">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                    </div>
                                </div>
